...
def start_cmd(Legend):
    ...
    START_OP = [
        [
            InlineKeyboardButton(text="🥀 Developer 🥀", url=f"https://t.me/LegendBot_Owner"),
            InlineKeyboardButton(text="✨ Support ✨", url=f"https://t.me/LegendBot_Group"),
        ],
        [
        ...
        [
            InlineKeyboardButton(text="❄️ Source Code ❄️", url=f"https://github.com/LEGEND-AI/BOTSPAM"),
